...
<!-- openclaw-memory-promotion:memory:memory/2026-08-14-pre-open.md:12:12 -->
- 盘前深度简报 · 2026-08-14 (周五) 08:00 HKT: 🧭 **Regime** (packet, per market): US `green` · HK `amber` (HSTECH 4,792 < MA200 5,192 -7.7%, lev_regime ×0.5, 趋势OFF: 杠杆敞口上限砍半). **macro.label `risk_on`** (VIX 14.63 +0.55%, F&G 66.1 greed, SPX 7,798.99 +0.65% / NDX 26,803.03 +0.81% / HSI 25,396.51 -0.17% / HSTECH 4,792.39 +0.33% / 10Y 4.641% / DXY 99.95). **US β 5.774** (=SPX -1% → 本子 -5.8%, 远超 3.0 cap). **7 breach 持续累计 (oldest 30d+, 0 overridden)** —— **risk_rule cuts 不受 risk_on HOLD 默认约束**; 三个 swap cut 是政策执行, 必须在 8/14 09:30 HKT (07226) + 8/14 09:30 ET (RKLX/SPCH) 开盘前挂单. [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-14-pre-open.md:12-12]
<!-- openclaw-memory-promotion:memory:memory/2026-08-14-pre-open.md:14:14 -->
- 盘前深度简报 · 2026-08-14 (周五) 08:00 HKT: **FX**: USDHKD = **7.8469** (Frankfurter, fetched 2026-08-14 00:03 UTC, age 7.9h). **🔒 HKD + USD 不能直接相加, book 段双视角展示**. [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-14-pre-open.md:14-14]
<!-- openclaw-memory-promotion:memory:memory/2026-08-14-pre-open.md:16:16 -->
- 盘前深度简报 · 2026-08-14 (周五) 08:00 HKT: **8/13 关键事件**: 00100 +5.43% 收 376.8 (1m +44.6% z+2.14 极端, 5d +27%); 07226 +0.68% 收 3.538 (chop 持续, 硬止损 -18.91%); 03032 +0.71% / 03033 +0.47% (跟 HSTECH 同步); 02208 -0.38% 收 10.62 (8/11 风电板块 -8% 已消化); RKLX -2.77% 收 24.20 (硬止损 -51.30% 持续 30d+); SPCH -6.78% 收 9.21 (硬止损 -27.23% 持续 30d+, 单名 76.69% mandatory breach); SPCX -3.33% 收 141.29 (5d +29.4% 强 trend, 1x 1x swap 接收方); CRCL +5.75% 收 75.38 (5d +13.1%, T+0 grade 🔴 追高低质); SKHY +7.29% 收 165.67 (peer WDC +7.3% / MU +4.2% 同步, T+0 grade 🟡 偏高位). [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-14-pre-open.md:16-16]
<!-- openclaw-memory-promotion:memory:memory/2026-08-14-pre-open.md:18:18 -->
- 盘前深度简报 · 2026-08-14 (周五) 08:00 HKT: > 🔴 **7 breach 累计 30+ 天 unack** — durable ledger 7 open / 0 overridden / oldest 30d. 8/13 plan 5 fired 杠杆硬切 sim filled 但 broker 端 0 个成交. **今日 8/14 是窗口**: 三个 swap cut 必成交以刷新 durable ledger, 否则 breach 继续累计 + chop_drag 0.74%/月 (07226) + 5.76%/月 (RKLX) 继续付. 8/15 US 休市, 8/16/17 周末, 8/18 下周一才能成交, 浪费 4 个交易日. [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-14-pre-open.md:18-18]
<!-- openclaw-memory-promotion:memory:memory/2026-08-14-pre-open.md:2:4 -->
- layout: default title: 盘前深度简报 · 2026-08-14 description: "clawock 2026-08-14 盘前: 7 breach 累计 30d+ 仍未动, 4 硬闸 (HK 杠杆 28.5%/US 杠杆 84.8%/US β 5.77/SPCH single_name 76.69%) + 3 硬止损 (07226/RKLX/SPCH). 8/14 是 8/15 美股休市前 US 最后一个交易日, 三个 swap cut 必须挂出." [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-14-pre-open.md:2-4]
<!-- openclaw-memory-promotion:memory:memory/2026-08-14-pre-open.md:9:10 -->
- 盘前深度简报 · 2026-08-14 (周五) 08:00 HKT: > Auto-generated by daily-deep-brief harness. 手写复盘覆盖本文件即可。 > **8/14 周五 nonfarm 前最后交易日, 8/15 美股休市 → 这是 8 月内最后一次 US 杠杆 1x swap 窗口**. [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-14-pre-open.md:9-10]
