...
<!-- openclaw-memory-promotion:memory:memory/2026-07-31-pre-open.md:11:13 -->
- 盘前深度简报 · 2026-07-31 (周五) 08:00 HKT: 🧭 **Regime**：US `neutral`（F&G 38.9 fear · VIX 17.09 (−17.28%) · SPX +1.66% / NDX +2.78% 同向上行）· HK `neutral`（HSTECH 4803.77 −1.25% · 仍 −8.7% vs MA200 · F&G 39 fear · 🧭 leverage regime **amber ×0.5**）。**FOMC 7/29 已出**；**7d 内最大单票催化：8/4 SPCX Q2 amc + 8/6 44% lockup**（双事件同周），其他 7d 仅 NFP 8/7 宏观催化。 **FX**：USDHKD = **7.8424**（⚠️ Frankfurter stale cache; all live sources failed · 抓取 2026-07-30T00:03 UTC；用前一日 rate 算 book，不影响单股 PnL 绝对值判断）。 **实时价快照**：HK 持仓来自 Tencent 2026-07-31 08:01 HKT（开盘前 89 分钟）；US 持仓来自 Eastmoney 2026-07-30（**⚠️ 5/7 US 票 staleness warn: CRCL/PLTU/RKLX/SPCX/SKHY/MSFU/SPCH 价格仍为 7/30 收盘**）。 [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-31-pre-open.md:11-13]
<!-- openclaw-memory-promotion:memory:memory/2026-07-31-pre-open.md:15:15 -->
- 盘前深度简报 · 2026-07-31 (周五) 08:00 HKT: > 🔴 **执行警报**（关键升级）：**7/30 plan 的 6 MOO 单 broker 端再次 0/6 fill**（07226 6200/PLTU 14/RKLX 10/SPCH 160/MSFU 20/00100 30 全部 simulated 触发但 portfolio.json 持股数零变化 — 7/29 也是 5/5 fail）。**8/4 SPCX Q2 + 8/6 44% lockup 仅 4 个交易日**，杠杆腿不换仓=接受双事件叠加。**今天是 6/6 MOO 三连挂后的最后宽限期**；再 0/6 必须立刻 research：broker 端是否限制了 leveraged ETF 卖单？是否需要分单走 TC/IBKR？ [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-31-pre-open.md:15-15]
<!-- openclaw-memory-promotion:memory:memory/2026-07-31-pre-open.md:19:21 -->
- Book（USD-base + HKD-base 双视角，绝不相加）: 真实总浮盈亏：**USD −8,225.27** ≈ HKD −64,505.85（USDHKD 7.8424） ├─ HK 段：**HKD −48,668.44** ≈ USD −6,205.83 └─ US 段：**USD −2,019.46** ≈ HKD −15,836.71 [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-31-pre-open.md:19-21]
<!-- openclaw-memory-promotion:memory:memory/2026-07-31-pre-open.md:2:4 -->
- layout: default title: 盘前深度简报 · 2026-07-31 description: "clawock 盘前深度简报 2026-07-31：9 breach + 4 硬止损持续, broker 6 单 MOO 三连挂 0/6 致命, 7/30 美股科技/MU/SK Hynix 强反弹(SOXX +5.79% / MSFT +15.5%) 但 HBM 估值疑虑新发, 今天必须降 US 杠杆敞口+HK 单因子, 8/4 SPCX Q2 + 8/6 44% lockup 是 7d 内最大单票事件。" [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-31-pre-open.md:2-4]
<!-- openclaw-memory-promotion:memory:memory/2026-07-31-pre-open.md:23:26 -->
- Book（USD-base + HKD-base 双视角，绝不相加）: | 段 | 真实成本 | 当前市值 | 现金 | 总浮亏 % | 主因 | |---|---|---|---|---|---| | HK | 100,676.44 HKD | 52,008.00 HKD | 22,197.00 HKD | **−48.34%** | 00100 −67% 单票吞噬 + 07226 2x 杠杆 | | US | 4,485.24 USD | 2,465.78 USD | ~100 USD | **−45.02%** | 6/7 票是 2x/3x 杠杆 ETF，β=3.49 × US 84.2% 杠杆敞口 | [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-31-pre-open.md:23-26]
<!-- openclaw-memory-promotion:memory:memory/2026-07-31-pre-open.md:9:9 -->
- 盘前深度简报 · 2026-07-31 (周五) 08:00 HKT: > Auto-generated by daily-deep-brief harness. 手写复盘覆盖本文件即可。 [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-31-pre-open.md:9-9]
