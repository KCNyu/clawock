...
<!-- openclaw-memory-promotion:memory:memory/2026-08-18-pre-open.md:12:12 -->
- 盘前深度简报 · 2026-08-18 (周二) 08:00 HKT: 🧭 **Regime** (packet): US `green` · HK `amber` (HSTECH 4,782 < MA200 5,180 -7.7%, 趋势OFF → 杠杆敞口上限砍半 25%). **macro.label `neutral`** (F&G 60.0 greed, VIX 15.19 calm 但 +6.6%, SPX+NDX 同向下行). **US β 5.5956** (SPX -1% → 本子 -5.6%, 远超 3.0 cap). [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-18-pre-open.md:12-12]
<!-- openclaw-memory-promotion:memory:memory/2026-08-18-pre-open.md:14:14 -->
- 盘前深度简报 · 2026-08-18 (周二) 08:00 HKT: **FX**: USDHKD = **7.8453** (Frankfurter, fetched 2026-08-18 08:01 HKT). **🔒 HKD + USD 不能直接相加, book 段双视角展示**. [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-18-pre-open.md:14-14]
<!-- openclaw-memory-promotion:memory:memory/2026-08-18-pre-open.md:18:20 -->
- ▎核心结论 (TL;DR): **3 个杠杆硬止损 + 4 条硬闸 unack 已累计 30d+, 今日是执行日**: 07226/RKLX/SPCH 三个 2x→1x swap cut 是风险政策执行 (driven_by=risk_rule), **不受 neutral regime 默认 HOLD 约束**, 必须今日开盘前挂单 (HK 09:25 / US 21:25 HKT)。昨日 (8/17) plan 同批 swap cut 因周末 + US 休市 0 成交, 今天不能再拖。; **执行时机有利**: 8/17 全线反弹 (HSTECH +1.58%, SPCX +4.45%, RKLB +2.28%, 南向净买 30.77 亿) — 借反弹流动性换仓, 正是政策要的"反弹一点不踏空"。; 核心仓位全部 hold: 00100 南向 8 连买 + M3/H3 催化未计价 (5d 仅 +1.4%), 02208 领涨风电 (回购 5 亿 + JPM 增持), SKHY 存储超级周期 (2027 短缺预警), CRCL 等 8/19 FOMC minutes。无 add 授权 (packet 全票 allowed=[hold/watch/cut])。 [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-18-pre-open.md:18-20]
<!-- openclaw-memory-promotion:memory:memory/2026-08-18-pre-open.md:2:4 -->
- layout: default title: 盘前深度简报 · 2026-08-18 description: "clawock 2026-08-18 盘前: 3 硬止损 (07226 -19.2% / RKLX -49.0% / SPCH -20.8%) + 4 仓位硬闸 (HK 杠杆 30.3% / SPCH 78.65% / US 杠杆 86.2% / US β 5.60), 30d+ unack 0 overridden. 3 个 2x→1x swap cut 是政策执行 (risk_rule), 今日开盘前必挂单." [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-18-pre-open.md:2-4]
<!-- openclaw-memory-promotion:memory:memory/2026-08-18-pre-open.md:26:29 -->
- Retrospective — 昨日 plan 兑现度 (2026-08-17 plan): | Action | Plan | 实际 | 模拟 ± | 评 | |---|---|---|---|---| | SPCH cut 200@开盘 | 200 股 | 未成交 (8/14 计划, 周末+US 休市 broker 0 成交) | — | ⊘ 待今日执行 | | RKLX cut 10@开盘 | 10 股 | 未成交 | — | ⊘ 待今日执行 | [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-18-pre-open.md:26-29]
<!-- openclaw-memory-promotion:memory:memory/2026-08-18-pre-open.md:9:10 -->
- 盘前深度简报 · 2026-08-18 (周二) 08:00 HKT: > Auto-generated by daily-deep-brief harness. 手写复盘覆盖本文件即可。 > **8/18 周二: HK 开盘前 90 分钟, US 已收盘 ~4 小时 (8/17 周一 session: SPX -0.52% / NDX -0.17% / VIX 15.19 +6.6%)**. [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-18-pre-open.md:9-10]
