...
<!-- openclaw-memory-promotion:memory:memory/2026-07-29-pre-open.md:11:13 -->
- 盘前深度简报 · 2026-07-29 (周三) 08:00 HKT: 🧭 **Regime**：US `risk_off`（F&G 38.5 fear · VIX 18.21 · max DD −39.0% · 🧭 leverage regime **red**）· HK `risk_off`（HSTECH 4730.61 −10.4% vs MA200 · 🧭 leverage regime **amber ×0.5**）。FOMC 利率决议今晚（02:00 ET）+ Powell 30 分钟前 + **MSFT Q4 AMC 5PM ET** 双线开盘前夜。 **FX**：USDHKD = **7.8416**（Frankfurter · 抓取 2026-07-29T00:01 UTC）。 **实时价快照**：HK 持仓来自 Tencent 2026-07-29 08:04 HKT；US 持仓来自 Eastmoney 2026-07-28 20:04 ET（昨夜美股已收）。 [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-29-pre-open.md:11-13]
<!-- openclaw-memory-promotion:memory:memory/2026-07-29-pre-open.md:15:15 -->
- 盘前深度简报 · 2026-07-29 (周三) 08:00 HKT: > 🔴 **执行警报**：**5 swaps 自 7/27 计划以来连挂 3 天未填实，07226 + PLTU + RKLX + SPCH + MSFU 股数未变 → portfolio.json 仍 6200/14/10/160/20**。今天必须 MOO 上 5 单市价，不再挂限价单（详见 Retrospective 与 Tier 3）。 [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-29-pre-open.md:15-15]
<!-- openclaw-memory-promotion:memory:memory/2026-07-29-pre-open.md:19:21 -->
- Book（USD-base + HKD-base 双视角，绝不相加）: 真实总浮盈亏：**USD −8,458.53** ≈ HKD −66,328.45（USDHKD 7.8416） ├─ HK 段：**HKD −50,079.24** ≈ USD −6,386.35 └─ US 段：**USD −2,072.18** ≈ HKD −16,245.13 [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-29-pre-open.md:19-21]
<!-- openclaw-memory-promotion:memory:memory/2026-07-29-pre-open.md:2:4 -->
- layout: default title: 盘前深度简报 · 2026-07-29 description: "clawock 盘前深度简报 2026-07-29：HK amber + US red 满盘 12 breach、4 硬止损连挂 3 天未填实，FOMC + MSFT AMC 双线 — 必须 MOO 上 5 swaps。" [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-29-pre-open.md:2-4]
<!-- openclaw-memory-promotion:memory:memory/2026-07-29-pre-open.md:23:26 -->
- Book（USD-base + HKD-base 双视角，绝不相加）: | 段 | 真实成本 | 当前市值 | 现金 | 总浮亏 % | 主因 | |---|---|---|---|---|---| | HK | 100,676.44 HKD | 50,597.20 HKD | 22,197.00 HKD | **−49.74%** | 00100 单票 −68.1% 吞噬 + 07226 2x 杠杆二次跌 | | US | 4,561.68 USD | 2,489.50 USD | 100.04 USD | **−45.43%** | 4/7 票是 2x 杠杆 ETF，beta/decay 齐杀 + US β 4.17 vs SPX 1.0 | [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-29-pre-open.md:23-26]
<!-- openclaw-memory-promotion:memory:memory/2026-07-29-pre-open.md:28:28 -->
- Book（USD-base + HKD-base 双视角，绝不相加）: > USD cash **$100.04** = 已近 0（P0 持续）；HK cash **22,197 HKD** 略有余粮但不开放新仓位（regime risk_off + 12 breach 开放前禁止）。 [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-29-pre-open.md:28-28]
<!-- openclaw-memory-promotion:memory:memory/2026-07-29-pre-open.md:9:9 -->
- 盘前深度简报 · 2026-07-29 (周三) 08:00 HKT: > Auto-generated by daily-deep-brief harness. 手写复盘覆盖本文件即可。 [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-29-pre-open.md:9-9]
<!-- openclaw-memory-promotion:memory:memory/2026-07-28-pre-open.md:28:28 -->
- Book（USD-base + HKD-base 双视角，绝不相加）: > USD cash **$159.93** = 见底 (P0 持续)；HK cash **22,197 HKD** 略有余粮可补仓但纪律闸不开放新仓位。 [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-28-pre-open.md:28-28]
<!-- openclaw-memory-promotion:memory:memory/2026-07-27-pre-open.md:29:32 -->
- ▎Header（book + 持仓集中度）: | Leg | Currency | 持仓值 | Cash | 总浮亏 | 浮% | HHI | Top2% | Verdict | |---|---|---|---|---|---|---|---|---| | HK | HKD | 49,567 | 22,197 HKD | **-51,110** | **-50.8%** | **0.344** ⚠️ | **81.0%** | ⚠️ 集中风险 | | US | USD | 2,396 | 134 USD ⚠️ | **-2,106** | **-46.8%** | **0.249** ⚠️ | 60.8% | 偏集中 | [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-27-pre-open.md:29-32]
<!-- openclaw-memory-promotion:memory:memory/2026-07-27.md:26:29 -->
- 待 kcn 处理（开盘前 09:00 HKT / 21:30 ET）: **US 21:30 HKT（09:30 ET）开盘挂市价单**：; SPCH swap 150 股 → SPCX（市价单）; RKLX swap 10 股 → RKLB（市价单）; PLTU swap 14 股 → PLTR（市价单） [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-27.md:26-29]
