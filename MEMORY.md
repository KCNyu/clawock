...
<!-- openclaw-memory-promotion:memory:memory/2026-08-10-pre-open.md:11:11 -->
- 盘前深度简报 · 2026-08-10 (周一) 08:00 HKT: 🧭 **Regime** (packet, per market): US `green` · HK `amber` (HSTECH 4858 < MA200 5214 -6.8%, lev_regime ×0.5, 趋势OFF: 杠杆敞口上限砍半). **macro.label `risk_on`** (VIX 14.9 -1.65%, F&G 63.7 greed, SPX 7,757 +0.62% / NDX 26,690 +1.30% / HSI 25,668 +0.54% / HSTECH 4,858 +0.78%). **8/10 amc RKLB Q2 财报 + 8/12 Jul CPI 是本周双压顶**; **risk_rule cuts 不受 risk_on HOLD 默认约束**——8 breach 已累积 26d 全部 unacknowledged (durable ledger: 8 open / 0 overridden / oldest 26d), 今日必须出具体 1x swap 路径. [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-10-pre-open.md:11-11]
<!-- openclaw-memory-promotion:memory:memory/2026-08-10-pre-open.md:13:13 -->
- 盘前深度简报 · 2026-08-10 (周一) 08:00 HKT: **FX**: USDHKD = **7.8449** (Frankfurter, fetched 2026-08-10 00:44 UTC, age 8.0h). **🔒 HKD + USD 不能直接相加, book 段双视角展示**. [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-10-pre-open.md:13-13]
<!-- openclaw-memory-promotion:memory:memory/2026-08-10-pre-open.md:15:15 -->
- 盘前深度简报 · 2026-08-10 (周一) 08:00 HKT: **实时价快照**: HK 持仓来自 Tencent 2026-08-07 收盘; US 持仓来自 2026-08-07 16:00 ET close. 8/8-8/9 周末, **8/10 (今天) 是港股本周首开**. 8/7 关键事件: 00100 +9.83% 收 326.4 (5d +32% z+2.8σ 极端 overbought, 入通 + 海外霸榜 + 高盛上调三催化叠加); 07226 -1.50% 收 3.64 (chop, 杠杆 amber); 02208 +6.35% 收 11.55 (5d +11.3%); RKLX +18.79% 收 26.11 (8/10 amc 财报压顶); SPCH +31.43% 收 8.28 (8/7 lockup 卖压释放 + 强反弹, 硬止损 -38.3% 未消); MSFU -0.08% 收 38.26 (RSI 78.1 overbought 5d +5.1%); PLTU +20.56% 收 49.60 (RSI 72.8 z+2.5σ 5d +76.8% 极端); CRCL +5.36% 收 66.67 (5d +11.6%); SKHY -3.92% 收 137.91 (8/5 财报日 -13% 持续消化); SPCX +15.83% 收 133.11 (8/4 amc 财报 + 8/7 Musk endorse... [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-10-pre-open.md:15-15]
<!-- openclaw-memory-promotion:memory:memory/2026-08-10-pre-open.md:17:17 -->
- 盘前深度简报 · 2026-08-10 (周一) 08:00 HKT: > 🔴 **8 breach 全 26d unacknowledged, 今日是 breach 第 27 日**: durable ledger 8 open / 0 overridden / oldest 26d. 昨日 plan 5 fired 杠杆硬切 (00100 trim 30 + 07226 cut 6,200 + RKLX cut 10 + SPCH cut 190 + PLTU trim 2) 全部 simulated 成交, **但 active 实际执行率 5.13% (6/117)**——broker / 用户行为未确认, 价 8/8-9 周末未明. **今日必须给具体 1x swap 路径**: 3 leverage swap (RKLX→RKLB / SPCH→SPCX / 07226→03033) + 00100 trim 多波 (340/360 阶梯). **8/10 RKLB amc 是 RKLX 关键日, 8/12 CPI 是 US 杠杆头号宏观风险**. [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-10-pre-open.md:17-17]
<!-- openclaw-memory-promotion:memory:memory/2026-08-10-pre-open.md:2:4 -->
- layout: default title: 盘前深度简报 · 2026-08-10 description: "clawock 2026-08-10 盘前: 8 breach 26d 累积 (3 leverage swap + 00100 trim + RKLX/SPCH 硬止损 swap), 8/10 RKLB amc 财报压顶, 8/12 CPI 7d 头号宏观, Brier 0.32 信心校准不合格." [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-10-pre-open.md:2-4]
<!-- openclaw-memory-promotion:memory:memory/2026-08-10-pre-open.md:9:9 -->
- 盘前深度简报 · 2026-08-10 (周一) 08:00 HKT: > Auto-generated by daily-deep-brief harness. 手写复盘覆盖本文件即可。 [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-10-pre-open.md:9-9]
