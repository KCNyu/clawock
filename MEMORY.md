...
<!-- openclaw-memory-promotion:memory:memory/2026-07-30-pre-open.md:11:13 -->
- 盘前深度简报 · 2026-07-30 (周四) 08:00 HKT: 🧭 **Regime**：US `risk_off`（F&G 32.3 fear · VIX 20.66 (+13.45%) · SPX −1.52% / NDX −1.74% 同向下行 · 🧭 leverage regime **red**）· HK `risk_off`（HSTECH 4864.73 −7.7% vs MA200 · F&G 32 fear · 🧭 leverage regime **amber ×0.5**）。**FOMC 7/29 利率决议已出**（v2 brief 不再有 MSFT AMC 双重事件，但 8/3 PLTR Q2 amc 仍是 7d 内最大催化）。 **FX**：USDHKD = **7.8424**（Frankfurter · 抓取 2026-07-30T00:03 UTC）。 **实时价快照**：HK 持仓来自 Tencent 2026-07-30 08:03 HKT（开盘前 87 分钟）；US 持仓来自 Eastmoney/Finnhub 2026-07-29 20:04 ET（昨夜美股已收）。 [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-30-pre-open.md:11-13]
<!-- openclaw-memory-promotion:memory:memory/2026-07-30-pre-open.md:15:15 -->
- 盘前深度简报 · 2026-07-30 (周四) 08:00 HKT: > 🔴 **执行警报**：**7/29 plan 的 5 swaps broker 端再次 fail 0/5 fill**（simulated 全部 "trigger_fired=true" 但 portfolio.json 持股数未变: 07226 6200 / PLTU 14 / RKLX 10 / SPCH 160 / MSFU 20 / 00100 100）。**今天必须 MOO 上 5 swaps + 1 00100 trim MOO 共 6 单市价**，不再挂限价单（详见 Retrospective）。 [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-30-pre-open.md:15-15]
<!-- openclaw-memory-promotion:memory:memory/2026-07-30-pre-open.md:19:21 -->
- Book（USD-base + HKD-base 双视角，绝不相加）: 真实总浮盈亏：**USD −8,197.28** ≈ HKD −64,286.36（USDHKD 7.8424） ├─ HK 段：**HKD −47,128.44** ≈ USD −6,010.21 └─ US 段：**USD −2,187.84** ≈ HKD −17,158.84 [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-30-pre-open.md:19-21]
<!-- openclaw-memory-promotion:memory:memory/2026-07-30-pre-open.md:2:4 -->
- layout: default title: 盘前深度简报 · 2026-07-30 description: "clawock 盘前深度简报 2026-07-30：7/29 plan 5 swaps broker 三连挂失败, 7/30 必须 MOO 5 单市价减码 + 1 单 00100 trim。9 breach + 3 硬止损持续, US β 3.03 仍超 cap。" [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-30-pre-open.md:2-4]
<!-- openclaw-memory-promotion:memory:memory/2026-07-30-pre-open.md:23:26 -->
- Book（USD-base + HKD-base 双视角，绝不相加）: | 段 | 真实成本 | 当前市值 | 现金 | 总浮亏 % | 主因 | |---|---|---|---|---|---| | HK | 100,676.44 HKD | 53,548.00 HKD | 22,197.00 HKD | **−46.81%** | 00100 单票 −65.6% 吞噬 + 07226 2x 杠杆 | | US | 4,561.68 USD | 2,373.84 USD | ~100 USD | **−47.96%** | 4/7 票是 2x/3x 杠杆 ETF，beta/decay 齐杀 | [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-30-pre-open.md:23-26]
<!-- openclaw-memory-promotion:memory:memory/2026-07-30-pre-open.md:9:9 -->
- 盘前深度简报 · 2026-07-30 (周四) 08:00 HKT: > Auto-generated by daily-deep-brief harness. 手写复盘覆盖本文件即可。 [score=0.803 recalls=0 avg=0.620 source=memory/2026-07-30-pre-open.md:9-9]
