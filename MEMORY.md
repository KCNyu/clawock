...
<!-- openclaw-memory-promotion:memory:memory/2026-08-06-pre-open.md:11:11 -->
- 盘前深度简报 · 2026-08-06 (周四) 08:00 HKT: 🧭 **Regime** (packet, per market): US `red` (US β 6.05 + US levered 83.6% + lev_regime red) · HK `amber` (HK levered 36.5% 超 25% ×0.5 cap + factor 84.2% + 2 hard stop). **macro.label `neutral`** (VIX 15.81 -4.18%, F&G 59.7 greed ↑from 34.7 wk-ago, SPX 7,723.55 -0.17% / NDX 26,363.44 -0.83% 8/5 同步小幅回, HSI 25,915.82 +0.24% / HSTECH 4,933.07 +0.97% 8/5 收 +0.97% 维持 4,800 区间上沿). **risk_on HOLD 默认不适用** — 11 breach 22d 最老未消, 6 主动 call 全 risk_rule (政策) 不受 regime 约束; 主动 trim/cut 升级路径在 red/amber 下仍按 hard cap 走. [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-06-pre-open.md:11-11]
<!-- openclaw-memory-promotion:memory:memory/2026-08-06-pre-open.md:13:13 -->
- 盘前深度简报 · 2026-08-06 (周四) 08:00 HKT: **FX**: USDHKD = **7.8431** (Frankfurter, fetched 2026-08-06 00:01 UTC, age 7.4h). **🔒 HKD + USD 不能直接相加, book 段双视角展示**. [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-06-pre-open.md:13-13]
<!-- openclaw-memory-promotion:memory:memory/2026-08-06-pre-open.md:15:15 -->
- 盘前深度简报 · 2026-08-06 (周四) 08:00 HKT: **实时价快照**: HK 持仓来自 Tencent 2026-08-05 收盘; US 持仓来自 2026-08-05 16:00 ET close (8/4 amc PLTR Q2 beat +29.45% 跳空后 8/5 NDX -0.83% 回吐). 8/5 US 重大事件: PLTR/PLTU 财报后获利了结 (8/4 PLTU +57.87% 8/5 -0.06% 仅微跌, 跳空未全数回吐); CRCL 8/5 bmo Q2 财报 (8-K + 10-Q, EPS beat $0.27, revenue $713M 一致, 上调 other rev $310-330M, USDC circulation $73.3B, Arc token presale $242M); MSFT 8/5 10-K 文件 + Azure Q4 +43% YoY $100B 突破 (msfu_proxy 1d 跟涨). [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-06-pre-open.md:15-15]
<!-- openclaw-memory-promotion:memory:memory/2026-08-06-pre-open.md:17:17 -->
- 盘前深度简报 · 2026-08-06 (周四) 08:00 HKT: > 🔴 **broker 0/6 第 5 日 → 8/6 是杠杆 ETF hard cut 升级日**: 7/30 0/6, 7/31 0/6, 8/4 0/6, 8/5 0/6 (4 连挂阻断 swap fill, trim 部分 1/1 fill). **8/6 不再依赖 broker swap fill, 07226/RKLX/SPCH 三个 2x 杠杆 ETF 全部升级 hard cut @ open 全部清仓**; 00100/MSFU/PLTU 三个 trim 反射 n=6 0.83 win 是唯一显著正 edge, 继续执行. 4 个核心 (03032/03033/02208/CRCL/SKHY/SPCX) hold_and_watch. 8/7 NFP + 8/10 RKLB amc + 8/12 CPI 三事件压顶, 任何已 trim 仓位都别急回补. [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-06-pre-open.md:17-17]
<!-- openclaw-memory-promotion:memory:memory/2026-08-06-pre-open.md:2:4 -->
- layout: default title: 盘前深度简报 · 2026-08-06 description: "clawock 2026-08-06 盘前: broker 0/6 第 5 日 3 杠杆 hard cut 升级 + 3 trim 锁利, 11 breach 22d 未消." [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-06-pre-open.md:2-4]
<!-- openclaw-memory-promotion:memory:memory/2026-08-06-pre-open.md:9:9 -->
- 盘前深度简报 · 2026-08-06 (周四) 08:00 HKT: > Auto-generated by daily-deep-brief harness. 手写复盘覆盖本文件即可。 [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-06-pre-open.md:9-9]
