...
<!-- openclaw-memory-promotion:memory:memory/2026-08-05-pre-open.md:11:11 -->
- 盘前深度简报 · 2026-08-05 (周三) 08:00 HKT: 🧭 **Regime**: US `risk_on` (macro.label=risk_on, VIX 16.5 +4%, SPX+1.79% / NDX+2.59% 8/4 同步上行, F&G 58.1 greed ↑from 37.9 wk-ago) · HK `risk_on` (HSI 25,852.92 -0.6%, HSTECH 4,885.61 +0.21%, MA200 5,235 -6.7%). **book over-levered 凌驾 macro**: US β 5.23 (cap 3.0) + US levered_exp 85.3% (cap 50%) + 2 hard stop 已击穿 (RKLX -57.13% / SPCH -46.69%) + 8 breach 持续 → **纪律性再平衡强制走, 不受 risk_on HOLD 默认约束**. HK 杠杆制度 `amber` ×0.5 (HSTECH 趋势 OFF, 20d 波动 32% < 50%). [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-05-pre-open.md:11-11]
<!-- openclaw-memory-promotion:memory:memory/2026-08-05-pre-open.md:13:13 -->
- 盘前深度简报 · 2026-08-05 (周三) 08:00 HKT: **FX**: USDHKD = **7.8426** (Frankfurter, fetched 2026-08-05 00:01 UTC, age 1.4h). **🔒 HKD + USD 不能直接相加, book 段双视角展示**. [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-05-pre-open.md:13-13]
<!-- openclaw-memory-promotion:memory:memory/2026-08-05-pre-open.md:15:15 -->
- 盘前深度简报 · 2026-08-05 (周三) 08:00 HKT: **实时价快照**: HK 持仓来自 Tencent 2026-08-05 08:00 HKT (周二 1d 跌幅 1d -6.88% 在 00100); US 持仓来自 2026-08-04 16:00 ET close (**PLTR 8/3 amc 财报 beat, 8/4 1d 跳空 PLTR+29.45% / PLTU+57.87%**). [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-05-pre-open.md:15-15]
<!-- openclaw-memory-promotion:memory:memory/2026-08-05-pre-open.md:17:17 -->
- 盘前深度简报 · 2026-08-05 (周三) 08:00 HKT: > 🔴 **broker 0/6 第 4 个连续日 → 8/5 是硬止损升级日**: 7/29 0/5、7/30 0/6、7/31 0/6、8/4 0/6 = 4 连挂阻断 swap fill. 用户 8/4 自行 trim 4 PLTU @45 (已实现 +$16.17, 仓位 14→10), 是 4 天来唯一实际 fill. **8/5 不再依赖 broker swap fill, RKLX/SPCH 硬止损 + 00100/07226 cap breach 必须执行; broker 仍 0/6 第 5 日 = 默认接受硬扛 2 硬止损 + 8/5 CRCL bmo + 8/6 SPCX 911.5M shares (20% insider) lockup + 8/7 NFP + 8/10 RKLB amc + 8/12 CPI 五事件压顶**. [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-05-pre-open.md:17-17]
<!-- openclaw-memory-promotion:memory:memory/2026-08-05-pre-open.md:2:4 -->
- layout: default title: 盘前深度简报 · 2026-08-05 description: "clawock 盘前深度简报 2026-08-05: broker 0/6 第 4 日 + 2 硬止损(RKLX -57%/SPCH -47%) + 4 cap breach 持续, 4 risk_rule actions (RKLX/SPCH hard cut, 00100 trim 28@240, 07226 swap 2,103→03033) + 2 technical trim 锁利 (PLTU 2@44, MSFU 3@37). CRCL 8/5 bmo Q2 今日 hard catalyst." [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-05-pre-open.md:2-4]
<!-- openclaw-memory-promotion:memory:memory/2026-08-05-pre-open.md:9:9 -->
- 盘前深度简报 · 2026-08-05 (周三) 08:00 HKT: > Auto-generated by daily-deep-brief harness. 手写复盘覆盖本文件即可。 [score=0.803 recalls=0 avg=0.620 source=memory/2026-08-05-pre-open.md:9-9]
