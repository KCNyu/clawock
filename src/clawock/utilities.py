...
PACKAGED_UTILITIES = {
    ...
    "evaluate-add-shapes": "clawock.evaluation.add_shapes",
    ...
    "live-sources": "clawock.evidence.live_sources",
    ...
    "scorecard-provenance": "clawock.evidence.scorecard_verify",
    "run-card": "clawock.evidence.run_card",
    "sentiment": "clawock.market_data.sentiment",
    "shadow": "clawock.decision.shadow",
    "signal-panel": "clawock.evaluation.signal_panel",
...
UTILITY_HELP = {
    ...
    "evaluate-add-shapes": "what each add-side entry shape has been worth, against a baseline",
    "cron-trigger": "fire a host-triggered OpenClaw cron job (`openclaw cron run`)",
    ...
    "decision-map": "join every decision to the signals that existed when it was made",
    ...
    "live-sources": "fetch live free news and disclosures for a book, bounded",
    ...
    "scorecard-provenance": "show or verify what produced the published scorecard",
    ...
    "signal-panel": "score each registered signal source on the cross-section",
