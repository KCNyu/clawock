...
export interface DispatchTask {
  ...
  // ---- Queue fields (2026-09-26, interactive task queue). All optional on the wire, like
  // `stalls`: a client installed without a dsh restart still talks to the previous host.
