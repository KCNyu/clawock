#!/usr/bin/env python3
"""Generate CRON_SCHEDULES.md from config/cron-schedules.json."""
...
def main() -> int:
    ...
    if args.check:
        ...
        if current != content:
            print("CRON_SCHEDULES.md is stale; run generate_cron_docs.py")
            return 1
        print("CRON_SCHEDULES.md matches contract")
        return 0
