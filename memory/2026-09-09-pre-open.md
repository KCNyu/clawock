...
| SPCH | cut | 95% | <span class="verdict verdict-bearish">🔴 看空</span> | chop drag 1.2%/月 + breakeven 13.8% 5-sigma 不可达 + 86% US 单名集中 = 一次 -3% SPX 即可炸 book -5%. 9/4 + 9/8 两次 cut 计划 0 执行, 9/9 第 3 次重发, 9/8 单日 +7.4% 是反弹窗口不是新低日, 规则允许 cut | 若 SPCH 仓位已 0 (cut settlement 已成) 本条不再执行, 或若 SPCH 9/9 开盘再涨 +10% (4-sigma) 触发反弹持有观察 |
