...
**判定：⚪ 尚不可判** · 样本：留痕 51 天 · 来源：`assets/data/quant_signal_review.json`
...
| `trend_off_avoid` | 命中率 47.5% · CI95 [34.3%, 59.7%] · n=337（46 日 × 10 标的）· ⚪ CI 跨 50%，锁定 |
| `trend_on_follow` | 命中率 10.3% · CI95 — · n=39（39 日 × 1 标的）· ⚪ 样本只覆盖单一簇，算不出聚类 CI —— 无法解读 |
...
<sub>由 `clawock evidence` 生成于 2026-08-19T04:03:26+08:00。数字全部读自产物；改动结论请改产物，不要改这一页。</sub>
