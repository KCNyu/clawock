...
**判定：⚪ 尚不可判** · 样本：留痕 59 天 · 来源：`assets/data/quant_signal_review.json`
...
| `trend_off_avoid` | 命中率 50.6% · CI95 [38.8%, 62.1%] · n=348（51 日 × 10 标的）· ⚪ CI 跨 50%，锁定 |
...
| `clustered_edge` | [-0.103456, -0.001772] / 需要 CI lower > 0.0 · ⚪ 未达标 |
...
<sub>由 `clawock evidence` 生成于 2026-08-29T04:05:31+08:00。数字全部读自产物；改动结论请改产物，不要改这一页。</sub>
