...
**判定：⚪ 尚不可判** · 样本：留痕 68 天 · 来源：`assets/data/quant_signal_review.json`

| | |
|---|---|
| `rsi_overbought_fade` | 命中率 16.7% · CI95 [0.0%, 100.0%] · n=6（6 日 × 3 标的）· ⚪ 样本不足 MIN_N，方向结论不入决策（#934） |
| `rsi_oversold_bounce` | 命中率 63.0% · CI95 [30.8%, 100.0%] · n=27（17 日 × 8 标的）· ⚪ CI 跨 50%，锁定 |
| `stop_breach_continue` | 命中率 57.4% · CI95 [44.2%, 69.3%] · n=258（50 日 × 11 标的）· ⚪ CI 跨 50%，锁定 |
| `trend_off_avoid` | 命中率 53.5% · CI95 [42.5%, 64.5%] · n=396（60 日 × 10 标的）· ⚪ CI 跨 50%，锁定 |
...
| | |
|---|---|
| `prospective_dates` | 12 / 需要 24 · ⚪ 未达标 |
...
| `clustered_edge` | [-0.080559, 0.002056] / 需要 CI lower > 0.0 · ⚪ 未达标 |
...
<sub>由 `clawock evidence` 生成于 2026-09-11T04:04:23+08:00。数字全部读自产物；改动结论请改产物，不要改这一页。</sub>
