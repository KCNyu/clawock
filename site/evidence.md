...
**判定：⚪ 尚不可判** · 样本：留痕 67 天 · 来源：`assets/data/quant_signal_review.json`
...
| `stop_breach_continue` | 命中率 56.9% · CI95 [44.1%, 69.5%] · n=253（49 日 × 11 标的）· ⚪ CI 跨 50%，锁定 |
| `trend_off_avoid` | 命中率 53.3% · CI95 [42.3%, 65.0%] · n=390（59 日 × 10 标的）· ⚪ CI 跨 50%，锁定 |
...
| | |
|---|---|
| `prospective_dates` | 11 / 需要 24 · ⚪ 未达标 |
...
| `clustered_edge` | [-0.083486, 0.001478] / 需要 CI lower > 0.0 · ⚪ 未达标 |
...
<sub>由 `clawock evidence` 生成于 2026-09-10T04:05:17+08:00。数字全部读自产物；改动结论请改产物，不要改这一页。</sub>
