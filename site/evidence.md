...
**判定：⚪ 尚不可判** · 样本：留痕 55 天 · 来源：`assets/data/quant_signal_review.json`
...
| `trend_off_avoid` | 命中率 48.5% · CI95 [36.0%, 61.1%] · n=357（50 日 × 10 标的）· ⚪ CI 跨 50%，锁定 |
...
<sub>由 `clawock evidence` 生成于 2026-08-25T04:04:43+08:00。数字全部读自产物；改动结论请改产物，不要改这一页。</sub>
