...
**判定：⚪ 尚不可判** · 样本：留痕 66 天 · 来源：`assets/data/quant_signal_review.json`
...
| `stop_breach_continue` | 命中率 56.5% · CI95 [42.7%, 69.4%] · n=248（48 日 × 11 标的）· ⚪ CI 跨 50%，锁定 |
| `trend_off_avoid` | 命中率 53.1% · CI95 [41.9%, 64.7%] · n=384（58 日 × 10 标的）· ⚪ CI 跨 50%，锁定 |
...
| `clustered_edge` | [-0.085715, 0.001297] / 需要 CI lower > 0.0 · ⚪ 未达标 |
...
<sub>由 `clawock evidence` 生成于 2026-09-09T04:04:36+08:00。数字全部读自产物；改动结论请改产物，不要改这一页。</sub>
