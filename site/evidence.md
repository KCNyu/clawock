...
**判定：⚪ 尚不可判** · 样本：留痕 54 天 · 来源：`assets/data/quant_signal_review.json`
...
| `trend_off_avoid` | 命中率 48.0% · CI95 [35.5%, 59.9%] · n=352（49 日 × 10 标的）· ⚪ CI 跨 50%，锁定 |
| `trend_on_follow` | 命中率 10.0% · CI95 — · n=40（40 日 × 1 标的）· ⚪ 样本只覆盖单一簇，算不出聚类 CI —— 无法解读 |
...
<sub>由 `clawock evidence` 生成于 2026-08-22T16:00:04+08:00。数字全部读自产物；改动结论请改产物，不要改这一页。</sub>
