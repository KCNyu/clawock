...
**判定：⚪ 尚不可判** · 样本：留痕 65 天 · 来源：`assets/data/quant_signal_review.json`
...
| `stop_breach_continue` | 命中率 55.6% · CI95 [41.9%, 69.1%] · n=243（47 日 × 11 标的）· ⚪ CI 跨 50%，锁定 |
| `trend_off_avoid` | 命中率 52.6% · CI95 [40.7%, 64.6%] · n=378（57 日 × 10 标的）· ⚪ CI 跨 50%，锁定 |
...
| | |
|---|---|
| `prospective_dates` | 10 / 需要 24 · ⚪ 未达标 |
...
| `clustered_edge` | [-0.087257, 0.002468] / 需要 CI lower > 0.0 · ⚪ 未达标 |
...
<sub>由 `clawock evidence` 生成于 2026-09-07T12:04:05+08:00。数字全部读自产物；改动结论请改产物，不要改这一页。</sub>
