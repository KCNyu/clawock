...
例:UTC 2026-08-17 21:54 那次扫描,马斯克 SpaceX 相关的 5 条动态全部命中 SPCH/SPCX 持仓(held_hits=5),简报原样记下「撞持仓 (5 条全中 SPCH/SPCX)」;**UTC 2026-08-18 13:31 的下一次扫描只有 1 条动态、零持仓命中(held_hits=0),简报照实记空**——命中或落空都进简报,这里展示的是一次命中。两段都能从 8-18、8-19 两天的 pre-open 简报原文复核。
