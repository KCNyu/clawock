...
**判定：⚪ 尚不可判** · 样本：留痕 38 天 · 来源：`assets/data/quant_signal_review.json`

| | |
|---|---|
| `rsi_overbought_fade` | 命中率 100.0% · CI95 — · n=2（2 日 × 1 标的）· ⚪ CI 跨 50%，锁定 |
| `rsi_oversold_bounce` | 命中率 63.0% · CI95 [30.8%, 100.0%] · n=27（17 日 × 7 标的）· ⚪ CI 跨 50%，锁定 |
| `stop_breach_continue` | 命中率 53.9% · CI95 [36.7%, 69.6%] · n=243（33 日 × 10 标的）· ⚪ CI 跨 50%，锁定 |
| `trend_off_avoid` | 命中率 52.9% · CI95 [38.7%, 67.2%] · n=272（33 日 × 10 标的）· ⚪ CI 跨 50%，锁定 |
| `trend_on_follow` | 命中率 3.1% · CI95 — · n=32（32 日 × 1 标的）· ⚪ CI 跨 50%，锁定 |
...
<sub>由 `scripts/data/build_evidence.py` 生成于 2026-08-02T22:09:27+08:00。数字全部读自产物；改动结论请改产物，不要改这一页。</sub>
