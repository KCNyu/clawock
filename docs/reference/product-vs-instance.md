...
| Quant + research | `clawock quant` `clawock regime` `clawock t0` `clawock quant-review` `clawock t0-review` `cross_sectional_factor` `peer_residual_engine` `peer_scan` `suggest_peers` |
