---
layout: default
title: clawock · moved to the command reference
---
...
published long description cannot be edited.

本页已迁移到 [`docs/reference/commands.md`](commands.md)。旧路径保留，因为已发布的
PyPI 版本里写死了它，而已发布的 long description 改不了。
